...
class UpdateNotebookEndpointTest extends AbstractNotebookServerTest {
    ...
    private final String expectedFileContent = "{\"id\":\"2A94M5J2Z\",\"name\":\"" + editedTitle
            + "\",\"config\":{},\"paragraphs\":[{\"id\":\"20150213-230428_1231780373\",\"title\":\"\",\"script\":{\"text\":\"\\\"%test\\\\n## Congratulations, it's done.\\\\n##### You can create your own notebook in 'Notebook' menu. Good luck!\\\"\"}},{\"id\":\"20150326-214658_12335843\",\"title\":\"\",\"script\":{\"text\":\""
            + editedParagraphText
