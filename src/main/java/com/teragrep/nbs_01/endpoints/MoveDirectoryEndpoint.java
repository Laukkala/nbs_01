...
public class MoveDirectoryEndpoint implements EndPoint {

    private final Directory root;

    public MoveDirectoryEndpoint(Directory root) {
        this.root = root;
    }
    ...
    public Response createResponse(Request request) {
        try {
            ...
            String notebookId = parameters.getString("directoryId");
            String directoryId = parameters.getString("parentId");

            Directory directory = (Directory) updatedDirectory.findFile(notebookId).load();
            Directory parent = (Directory) updatedDirectory.findFile(directoryId);

            directory.move(parent);
            return new JsonResponse(HttpStatus.OK_200, "Moved directory " + directory.id());
        }
            ...
            return new JsonResponse(
                    ...
                    "Failed to move directory, reason:\n" + ioException
            );
        }
